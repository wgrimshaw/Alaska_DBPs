...
```{r}
## choose the optimal range of dataset of each bin. For missing monthly data, using mean value of that month data to fill the gap. Make sure the number of month is the same for each year in each bin.
#Bin 1
...
```{r}
## create the dataframe of bin and sens.slope
...
ggplot(AlaskaDischarge_9, aes(x = DATE, y = Discharge))+
  geom_line()
