...
discharge_plot <- ggplot(AlaskaTempPrecipDischarge)+
  geom_line(aes(x = DATE, y = Discharge, color = Bin)) # add a representative line
...
linearinterpolation <- as.data.frame(approx(Alaska_3$Discharge,n = 1252, method = "linear"))# don't know why the data ends at 2004, it should be ended at 2019/10
