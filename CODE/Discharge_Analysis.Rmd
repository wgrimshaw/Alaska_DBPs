...
AlaskaDischarge_4_2 <-na.interp(AlaskaDischarge_4)
discharge_4_plot <-ggplot()+
  geom_line(AlaskaDischarge_4, aes(x = DATE, y = Discharge,series= 'Original' ))+
  geom_line(AlaskaDischarge_4_2, aes(x = DATE, y = Discharge, series= 'Interpolated'))+
print(discharge_4_plot)
```
