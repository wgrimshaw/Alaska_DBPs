...
```{r}
AlaskaTempPrecipDischarge <- merge(TempPrecip, NWIS_Discharge, by = c('DATE', 'Bin'))
```

## Export AlaskaTempPrecipDischarge CSV
```{r}
###AlaskaTempPrecipDischarge<-write.csv(AlaskaTempPrecipDischarge, "AlaskaTempPrecipDischarge.csv")
```
