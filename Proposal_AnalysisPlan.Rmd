...
1.	Choose 10 points for one same latitude and divide Alaska into 5 regions by longitude. Plot ggplot of discharge vs longitude to show the relationship. (Q: should we choose the river that came across for the whole N-S of Alaska, otherwise how do we control the effect of other parameters?)
2.	Choose 5 different rivers where they are in different temperature region, plot ggplot of discharge vs mean air temperature. 
