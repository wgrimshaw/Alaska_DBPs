...
<<<<<<< HEAD
1.	Choose 10 points for each same latitude and divide Alaska into 5 regions by latitude. Plot ggplot of discharge over time for each latitude region to explore the discharge change in different regions. 
2.	Choose 5 different rivers where they are in different temperature region, compare the change of discharge over time in different air temperature region. Plot ggplot of discharge vs time for each temperature region. 
3.	Use high frequency data of discharge to do monotonic trend analysis and also use ARMA model to predict the discharge in the future. Plot the decomposed dataset and the prediction of discharge.
=======

* Choose 10 sites for each same latitude and divide Alaska into 5 regions by latitude  
...
>>>>>>> 5fb2dceb962d04dd92248105e87dedb1c6350b54
