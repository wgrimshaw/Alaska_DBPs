...
NWIS_Discharge$Bin<-revalue(NWIS_Discharge$site_no,
       c('15297680'='1', '15297610'='2','15072000'='3', 
...
AlaskaTempPrecipDischarge <- TempPrecip %>%
  ...
  rename(replace = c("X_00060_00003" = "Discharge")) %>%
...
```{r, fig.width=14, fig.height=6, echo = FALSE, warning=FALSE, message=FALSE}
...
#Snowmelt.Discharge.Median <- Snowmelt.Discharge.Spring %>% group_by(Bin, DOY) %>%
#  mutate(Dis.Med = median(Discharge))
#
#dis.doy.med <- ggplot(Snowmelt.Discharge.Median) +
#  geom_line(aes(x = DOY, y = Dis.Median, color = as.factor(Bin))) +
#  labs(x = "Day of Year", y = "Median Discharge, cfs", color = "Latitude Bin") +
...
>>>>>>> bdc358699638beecd27d5c03f59d01de85df7457
