...
>>>>>>> dfb6c8aa743b1264eb599038a4061410c50c7f69
```{r}
...
Discharge_output <- read.csv("./DATA/PROCESSED/Discharge_Change.csv")
...
kable(Output_Summary, format = "html", 
       ...
       col.names = c("Latitude Bin", "Temperature Change, °F/yr", 
                     "Discharge Change, cfs/yr", "Change in Day of Year, days/yr"),
       align = "c",
       digits=2) %>%
   kable_styling(bootstrap_options = c("striped", "condensed"),
                 full_width = TRUE,
