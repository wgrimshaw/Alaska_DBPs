...
```{r Scatterplot of Full Precipitation Record by Bin, fig.width=10, fig.height=5}
...
# GRAPH 1
```{r, fig.cap= c("Day of Year vs. Mean Precipitation. This figure shows mean precipitation across all nine latitude bins for each day of the year. This graph served to illustrate precipitation variation across sites."), fig.width=6, fig.height=3}
...
scale_colour_manual(values = c("#00CED1", "#000000", "#FFFF00", "#FF8C00", "#9400D3", "#191970", "#228B22", "#FF00FF", "#CD5C5C"))+
...
```
 dark turquiose, black, yellow, dark orange, dark violet, midnight blue, forest green, magenta, indian red

# GRAPH 2
```{r, fig.cap= c("Day of Year vs. Precipitation. This figure shows how precipitation changes with day of year across the period of record for Bin 6."), fig.width=6,fig.height=3}
...
```{r Exploratory Mapping, warning=FALSE, message=FALSE}
...
# Map of NOAA Site Locations in Alaska
```{r NOAA Site Locations across Alaska}
ggplot() +
  geom_sf(data = Alaska_sf_utm, color = "black") +
  geom_sf(data = NOAA_sf_utm, color = "red")+
    ggtitle("NOAA Site Locations in Alaska")+
  gabytheme
```
...
AlaskaPrecipMap<-ggplot(axes = FALSE) +
  ...
  theme(legend.key.size=unit(1.5, "cm"))+
    ggtitle("Mean Precipitation across Alaska by Bin")+
